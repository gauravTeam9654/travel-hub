...
const HiddenPackagePage = () => {
  ...
  useEffect(() => {
    const fetchPackage = async () => {
      try {
        const docRef = doc(db, "hiddenGems", decodedSlug);
  ...
  const handleWhatsApp = () => {
    const message = `Hi TravelHub! I'm interested in the Hidden Gem: "${pkg.title}" package (${pkg.days}). Could you please share more details?`;
    ...
    <div className="modern-package-container">
      ...
      <main className="pkg-main-grid">
        <div className="pkg-left-col">
          ...
          {/* About Section */}
          <div className="pkg-card">
            <h2 className="pkg-section-title">Why This Gem?</h2>
          ...
          {pkg.itinerary && pkg.itinerary.length > 0 && (
            <div className="pkg-card">
              <h2 className="pkg-section-title">Unique Itinerary</h2>
              <div className="itinerary-list">
                {pkg.itinerary.map((day, i) => (
                  <div key={i} className="itinerary-day-card">
                    ...
                    <h3 className="itinerary-day-title">{day.title || `Day ${i + 1} Adventure`}</h3>
        ...
        <div className="pkg-sidebar">
          <div className="sticky-sidebar">
            <div className="price-card">
              <p className="price-label">Experience Price</p>
              <h3 className="price-value">₹{pkg.price}</h3>
              <p className="price-subtext">per person (limited availability)</p>
